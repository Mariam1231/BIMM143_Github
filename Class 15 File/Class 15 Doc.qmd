---
title: "Class 15: Perussis Mini-project"
...
Pertussis, aka whooping cough, is a highly contagious disease caused by the bacteria *B. Pertussis*

The CDC tracks pertussis case numbers per year. Let's have a close look at this data:
...
Add some landmark developments as annotation to our plot. We include the first whole-call (wP) vaccine roll-out in 1946.
...
> Q3. How mant male/female 

```{r}
table(subject$biological_sex)
```

> Q4. Breakdown by biological sex and race, e.g. how many black female subjects etc
...
Make a first plot of MFI (mean florescence intensity - a measure of how much is detected) for each antigen
...
Looks like we don't have data yet or all subjects in terms of visits 8 onwards. So lets exclude these.
